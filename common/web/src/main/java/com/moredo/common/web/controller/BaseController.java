package com.moredo.common.web.controller;

import com.moredo.common.utils.common.Page;
import com.moredo.common.web.annotation.MsgCode;
import com.moredo.common.web.config.error.ErrorCodeProperties;
import com.moredo.common.web.exception.CommonException;
...
public class BaseController {
    ...
    public Map<String, Object> success(String key, Object result) {
        Map<String, Object> data = new HashMap<String, Object>();
        data.put(CODE_KEY, 0);
        data.put(key, result);
        return data;
    ...
    public Map<String, Object> success(String key, Object result, String message) {
        Map<String, Object> data = success(key, result);
        data.put(MESSAGE_KEY, message);
        return data;
    }

    public Map<String, Object> result(Integer code, Object message) {
        Map<String, Object> data = new HashMap<String, Object>();
    ...
    public Map<String, Object> result(Integer code, Object message, Object result) {
        Map<String, Object> data = new HashMap<String, Object>();
        data.put(CODE_KEY, code);
        data.put(MESSAGE_KEY, message);
    ...
    public Map<String, Object> failed(Integer code) {
        return this.failed(code, null);
    }

    public Map<String, Object> failed(Integer code, String... values) {
        Map<String, Object> data = new HashMap<String, Object>();
    ...
    public Map<String, Object> result(Page<?> result) {
        Map<String, Object> data = new HashMap<String, Object>();
        data.put(CODE_KEY, 0);
